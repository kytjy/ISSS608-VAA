...
**Using `scale_color_viridis_d()`** The code below uses `scale_color_viridis_d()` discrete colour scale instead, and does not require Gapminder package to be loaded.
...
## 3.2.1 Reveal data along a given dimension
