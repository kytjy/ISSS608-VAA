...
![](Images/placeholder-simmer.PNG){fig-align="center"}
...
There are 222 unique countries in the dataset.
...
**Using `scale_color_viridis_d()`** The code below uses `scale_color_viridis_d()` colour scale instead, and does not require Gapminder package to be loaded.
...
Plot looks weird because a lot of countries for each continent.
:::
