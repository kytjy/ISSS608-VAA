...
![](images/interactivemap.gif){fig-align="center"}
...
tmap_arrange(fill, border, nrow =1)
```
...
tmap_arrange(multival, asp =1, nrow = 1)
```
...
tmap_arrange(multival2, asp =1, nrow = 1)
```
...
### 5.6.4 By creating multiple stand-alone maps with `tmap_arrange()`
